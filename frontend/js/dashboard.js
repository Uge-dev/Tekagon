...
async function buildPage(pageKey) {
    ...
    if (pageKey === 'profile') {
      pageEl.innerHTML = `
 <div class='prof-bkg' style="background-image: url('${pageData.profile.banners[0].image}');">
        ...
        <div class="whatsapp-modal">
          ...
          <div class="modal-body">
            <div class="business-hours-info">
              ...
              <span class= "hours-card-top"> <i class="fas fa-clock"></i>
                 Business Hours</span>
   ...
   <section class="contact-section">
    ...
    <div class="feature-content">
      ...
      <div class="feature-text">
        ...
        <button class="feature-btn" onclick="buildPage('profile')">Discover More</button>
      </div>
    </div>
  `;
